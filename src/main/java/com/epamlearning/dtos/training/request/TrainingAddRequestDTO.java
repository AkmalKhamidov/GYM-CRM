...
public class TrainingAddRequestDTO implements BaseDTO {
    ...
    @Schema(description = "Training name", example = "Java", requiredMode = REQUIRED)
    ...
    @Schema(description = "Training date (FUTURE/PRESENT DATE)", example = "22-01-2024", requiredMode = REQUIRED)
