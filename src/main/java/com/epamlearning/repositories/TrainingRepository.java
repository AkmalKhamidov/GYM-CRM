...
public interface TrainingRepository extends JpaRepository<Training, Long>, BaseRepository {
    ...
    List<Training> findTrainingsByTrainerAndCriteria(Trainer trainer, LocalDate startDate, LocalDate endDate, TrainingType trainingType, String traineeName);
    ...
    List<Training> findTrainingsByTraineeAndCriteria(Trainee trainee, LocalDate startDate, LocalDate endDate, TrainingType trainingType, String trainerName);
