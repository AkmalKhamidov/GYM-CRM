...
public class TraineeControllerTest {
    ...
    void getTraineeProfile_shouldReturnTraineeProfile() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/trainee/John.Doe")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void updateTraineeProfile_shouldReturnUpdatedTraineeProfile() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/trainee/John.Doe")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void deleteTrainee_shouldReturnOk() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/trainee/John.Doe")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    void updateTrainersOfTrainee_shouldReturnUpdatedTrainersList() throws Exception {
        ...
        when(traineeService.updateTrainersForTrainee(anyString(), (UpdateTrainersOfTraineeRequestDTO) any())).thenReturn(expectedResponseDTO);

        mockMvc.perform(put("/api/v1/trainee/John.Doe/trainers")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(asJsonString(trainersOfTraineeDTO)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(expectedResponseDTO.size()));

        verify(traineeService, times(1)).updateTrainersForTrainee(anyString(), (UpdateTrainersOfTraineeRequestDTO) any());
    }
